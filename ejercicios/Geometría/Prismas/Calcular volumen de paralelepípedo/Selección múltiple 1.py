...
contenido_correcto = Matematica(x*y*z+" "+potencia(unidad_de_medida,3,parentesis_automatico=False),arreglar_espacios=True)
contenido_2 =        Matematica(x+y+z+" "+potencia(unidad_de_medida,3,parentesis_automatico=False),arreglar_espacios=True)
contenido_3 =        Matematica(2*(x*y+y*z+x*z)+" "+potencia(unidad_de_medida,3,parentesis_automatico=False),arreglar_espacios=True)
contenido_4 =        Matematica(2*(x+y+y+z+x+z)+" "+potencia(unidad_de_medida,3,parentesis_automatico=False),arreglar_espacios=True)
contenido_5 =        Matematica(x*y+y*z+x*z+" "+potencia(unidad_de_medida,3,parentesis_automatico=False),arreglar_espacios=True)
