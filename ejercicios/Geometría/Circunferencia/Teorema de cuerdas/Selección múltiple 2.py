...
while ea+ec-eb-ed==0:
    ea, eb, ec, ed = Racional(randrange(1, 15)), Racional(randrange(1, 15)), Racional(randrange(1, 15)), Racional(randrange(1, 15))
x = (eb*ed-ea*ec)/(ea+ec-eb-ed)
while ea+ec-eb-ed==0 or eb+ec-ea-ed==0 or ea*ec-ed*eb==0 or eb*ec-ed*ea==0 or x+ea<=0 or x+eb<=0 or x+ec<=0 or x+ed<=0:
    ea, eb, ec, ed = Racional(randrange(1, 15)), Racional(randrange(1, 15)), Racional(randrange(1, 15)), Racional(randrange(1, 15))
    while ea+ec-eb-ed==0:
        ea, eb, ec, ed = Racional(randrange(1, 15)), Racional(randrange(1, 15)), Racional(randrange(1, 15)), Racional(randrange(1, 15))
    x = (eb*ed-ea*ec)/(ea+ec-eb-ed)
...
Si {Matematica(linea(letra_E+letra_A))} mide {Matematica(Pol("x",ea,parentesis=True)+" "+unidad_de_medida,arreglar_espacios=True)}, {Matematica(linea(letra_E+letra_B))} mide {Matematica(Pol("x",eb,parentesis=True)+" "+unidad_de_medida,arreglar_espacios=True)}, {Matematica(linea(letra_E+letra_C))} mide {Matematica(Pol("x",ec,parentesis=True)+" "+unidad_de_medida,arreglar_espacios=True)} y {Matematica(linea(letra_E+letra_D))} mide {Matematica(Pol("x",ed,parentesis=True)+" "+unidad_de_medida,arreglar_espacios=True)}, ¿cuál es el valor de x?"""

#================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero==
contenido_correcto = Matematica((eb*ed-ea*ec)/(ea+ec-eb-ed))
contenido_2 = Matematica((eb*ec-ed*ea)/(eb+ec-ea-ed))
contenido_3 = Matematica(Root(abs(ea*ec-ed*eb))/(ea+ec-eb-ed))
contenido_4 = Matematica((ea+ec-eb-ed)/(ea*ec-ed*eb))
contenido_5 = Matematica((eb+ec-ea-ed)/(eb*ec-ed*ea))
