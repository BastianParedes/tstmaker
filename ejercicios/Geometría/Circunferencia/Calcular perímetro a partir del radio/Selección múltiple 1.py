...
if -10<=angulo<=10:
    ...
    \end{{tikzpicture}}
    \end{{center}}
    El perímetro de dicha circunferencia es"""
...
contenido_3 = Matematica(r**2*PI()+" "+unidad_de_medida, arreglar_espacios=True)
contenido_4 = Matematica(2*r/PI()+ " "+unidad_de_medida, arreglar_espacios=True)
contenido_5 = Matematica((r/2)*PI()+" "+unidad_de_medida, arreglar_espacios=True)
