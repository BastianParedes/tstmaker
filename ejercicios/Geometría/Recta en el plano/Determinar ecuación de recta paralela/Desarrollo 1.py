...
enunciado = "Sea la recta L cuya ecuación es "+Matematica(L.show_ecuacion_principal)+". Determina la ecuación de la ecuación de la recta que es paralela a L y pasa por el punto "+Matematica(Par(x3,y3))+"."
