...
enunciado = "Sea la recta L cuya ecuación es "+Matematica(L.show_ecuacion_principal)+". La ecuación de la recta que es paralela a L y pasa por el punto "+Matematica(Par(x3,y3))+" es"

#================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero==
contenido_correcto = Matematica(Recta(Par(x3,y3),pendiente=L.m).show_ecuacion_principal)
contenido_2 = Matematica(L.show_ecuacion_principal)
contenido_3 = Matematica(Recta(Par(x3,y3),pendiente=-1/L.m).show_ecuacion_principal)
