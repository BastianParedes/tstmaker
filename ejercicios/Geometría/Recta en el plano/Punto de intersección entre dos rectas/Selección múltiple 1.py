...
El punto de intersección entre ${sub("L",1)}$ y ${sub("L",2)}$ es"""

#================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero==
contenido_correcto = Matematica(Par((L2.n-L1.n)/(L1.m-L2.m), L1.m*(L2.n-L1.n)/(L1.m-L2.m)+L1.n))
contenido_2 = Matematica(Par(-(L2.n-L1.n)/(L1.m-L2.m), L1.m*(L2.n-L1.n)/(L1.m-L2.m)+L1.n))
contenido_3 = Matematica(Par((L2.n+L1.n)/(L1.m+L2.m), L1.m*(-L2.n-L1.n)/(L1.m-L2.m)-L1.n))
contenido_4 = Matematica(Par((L2.n+L1.n)/(L1.m+L2.m), L1.m*(-L2.n-L1.n)/(L1.m-L2.m)+L1.n))
contenido_5 = Matematica(Par((L2.n-L1.n)/(L1.m-L2.m), L1.m*(L2.n-L1.n)/(L1.m-L2.m)-L1.n))
