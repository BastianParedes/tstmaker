...
contenido_3 = Matematica(potencia(Pol("x",-h),2)+"+"+potencia(Pol("y",-k),2)+"="-r**2)
contenido_4 = Matematica(potencia(Pol("x",h),2)+"+"+potencia(Pol("y",-k),2)+"="+choice([-r**2,r**2]))
contenido_5 = Matematica(potencia(Pol("x",-h),2)+"+"+potencia(Pol("y",k),2)+"="+choice([-r**2,r**2]))
