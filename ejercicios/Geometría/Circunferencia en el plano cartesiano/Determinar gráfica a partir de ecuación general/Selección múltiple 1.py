...
enunciado = f"¿Cuál de las siguientes gráficas representa mejor a la circunferencia C cuya ecuación general es {Matematica(Pol({'x':2}, {'y':2}, -2*h*'x', -2*k*'y', h**2+k**2-r**2)+'=0')}?"
