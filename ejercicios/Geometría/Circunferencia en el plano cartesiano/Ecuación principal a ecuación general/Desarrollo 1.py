...
enunciado = "La ecuación principal de una circunferencia es "+Matematica(potencia(Pol("x",-h),2)+"+"+potencia(Pol("y",-k),2)+"="+r**2)+". Calcula la ecuación general de dicha circunferencia."
