...
contenido_correcto = Matematica(lado**2+" "+potencia(unidad_de_medida,2,parentesis_automatico=False))
contenido_2 = Matematica(4*lado+" "+potencia(unidad_de_medida,2,parentesis_automatico=False))
