...
contenido_correcto = Matematica((2*b+2*h)+" "+potencia(unidad_de_medida,2,parentesis_automatico=False))
contenido_2 = Matematica(b*h+" "+potencia(unidad_de_medida,2,parentesis_automatico=False))
