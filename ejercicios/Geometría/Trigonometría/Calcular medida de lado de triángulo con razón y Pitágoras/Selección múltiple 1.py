...
if opcion==1:
    ...
    ¿Cuánto mide el lado AC? Considera """ + Matematica(r"tan "+Racional(angulo)+"°="+razon, arreglar_espacios=True)
    #================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero==
    contenido_correcto = Matematica(Root(lado**2+segundo_lado**2))+" "+unidad_de_medida
    contenido_2 = Matematica(lado*razon)+" "+unidad_de_medida
    contenido_3 = Matematica(razon/lado)+" "+unidad_de_medida
    contenido_4 = Matematica(segundo_lado)+" "+unidad_de_medida
    contenido_5 = Matematica(Root(abs(lado**2-segundo_lado**2)))+" "+unidad_de_medida
    ...
    #================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero==
    contenido_correcto = Matematica(Root(abs(lado**2-segundo_lado**2)))+" "+unidad_de_medida
    contenido_2 = Matematica(lado*razon)+" "+unidad_de_medida
    contenido_3 = Matematica(razon/lado)+" "+unidad_de_medida
    contenido_4 = Matematica(Root(lado**2+segundo_lado**2))+" "+unidad_de_medida
    contenido_5 = Matematica(segundo_lado)+" "+unidad_de_medida
