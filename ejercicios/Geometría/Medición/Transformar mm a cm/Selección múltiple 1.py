...
contenido_correcto = Matematica(Racional(a/10,cargar_decimal=True)+" cm")
contenido_2 = Matematica(Racional(a/100,cargar_decimal=True)+" cm")
contenido_3 = Matematica(Racional(a/1000,cargar_decimal=True)+" cm")
contenido_4 = Matematica(Racional(a*10,cargar_decimal=True)+" cm")
