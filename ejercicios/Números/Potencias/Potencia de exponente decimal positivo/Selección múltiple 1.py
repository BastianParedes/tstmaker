...
contenido_correcto = Matematica("x"**exponente)
contenido_2 = Matematica(fraccion(1,"x")**exponente)
contenido_3 = Matematica("x"**(-exponente))
contenido_4 = Matematica(fraccion(1,"x")**(-exponente))
contenido_5 = Matematica(potencia(exponente,"x"))
