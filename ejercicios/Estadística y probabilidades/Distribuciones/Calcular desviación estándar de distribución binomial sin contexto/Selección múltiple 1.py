...
enunciado = "Sea la variable aleatoria X tal que "+Matematica(fr"X\sim B({n}; {Racional(p,100,True)})", arreglar_espacios=True)+ ". La desviación estándar de X es"

#================================Aquí se escriben los contenidos 0de las alternativas. Pon el correcto en el primero==
contenido_correcto = Matematica(Root(n*(p/100)*(1-p/100)))
contenido_2 = Matematica(n*(p/100)*(1-p/100))
contenido_3 = Matematica(Racional(n*p,100))
contenido_4 = Matematica(n*p)
