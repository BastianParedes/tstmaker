...
{choice(["La media","El promedio"])} de este conjunto es"""
...
contenido_3 = Matematica(desviacion_media) #Calcula el promedio
contenido_4 = Matematica(varianza) #Calcula la varianza
contenido_5 = Matematica(desviacion_estandar) #Calcula la desviación estándar
