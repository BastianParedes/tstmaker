...
enunciado = "El recorrido de la función " +Matematica(letra_de_funcion+"(x)="+Pol(Term(a,{"x":2}), b*"x", c, azar=True))+ " es"

#================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero==
if a<0:
    contenido_correcto = Matematica(fr"\left]-{INF()}, {(4*a*c-b**2)/(4*a)}\right]", arreglar_espacios=True)
    ...
    contenido_5 = Matematica(letra_conjunto("R"))

elif 0<a:
    contenido_correcto = Matematica(fr"\left[{(4*a*c-b**2)/(4*a)}, +{INF()}\right[", arreglar_espacios=True)
    contenido_2 = Matematica(fr"\left[{-b/(2*a)}, +{INF()}\right[", arreglar_espacios=True)
    contenido_3 = Matematica(letra_conjunto("R"), arreglar_espacios=True)
    contenido_4 = Matematica(fr"\left]-{INF()}, {-b/(2*a)}\right]", arreglar_espacios=True)
