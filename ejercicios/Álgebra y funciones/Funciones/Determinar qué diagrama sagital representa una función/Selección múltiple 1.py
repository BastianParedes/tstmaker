...
enunciado = "¿En cuál de los siguientes diagramas sagitales se representa una función?"
#===================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero.
contenido_correcto = choice([funcion_no_sobre_no_iny(), funcion_si_sobre_no_iny(), funcion_no_sobre_si_iny(), funcion_bi()])
contenido_2 = dominio_usado_con_uno_extra()
contenido_3 = dominio_sin_usar_por_completo_sin_repeticion()
contenido_4 = dominio_sin_usar_por_completo_con_repeticion()
