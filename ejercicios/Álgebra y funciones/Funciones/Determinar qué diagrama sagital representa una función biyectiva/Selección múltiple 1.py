...
enunciado = f"¿En cuál de los siguientes diagramas sagitales se representa una función {choice(['que tiene una función inversa', 'biyectiva'])}?"
#===================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero.
contenido_correcto = funcion_bi()
contenido_2 = funcion_no_sobre_no_iny()
contenido_3 = funcion_si_sobre_no_iny()
contenido_4 = funcion_no_sobre_si_iny()
