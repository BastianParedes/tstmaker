...
enunciado = "¿En cuál de los siguientes diagramas sagitales se representa una función inyectiva?"
#===================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero.
contenido_correcto = choice([funcion_no_sobre_si_iny(), funcion_bi()])
contenido_2 = funcion_no_sobre_no_iny()
contenido_3 = funcion_si_sobre_no_iny()
contenido_4 = dominio_sin_usar_por_completo_sin_repeticion()
