...
if opcion==1:
    ...
    enunciado = f"¿Cuál de las siguientes ecuaciones se obtiene al {operacion} {abs(c)} en ambos lados de la ecuación {Matematica(Pol('x',a)+'='+b)}?"
    ...
    #===============================================Aquí va el número del ejercicio y el enunciado.
    enunciado = f"¿Cuál de las siguientes ecuaciones se obtiene al {operacion} {abs(c)} en ambos lados de la ecuación {Matematica(b+'='+Pol('x',a))}?"
    #===================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero.
