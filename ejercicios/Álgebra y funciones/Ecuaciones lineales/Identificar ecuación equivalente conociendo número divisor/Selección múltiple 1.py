...
c2i, c2d, c3i, c3d, c4i, c4d, c5i, c5d = Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0))
while c2i==c2d or c3i==c3d or c4i==c4d or c5i==c5d:
    c2i, c2d, c3i, c3d, c4i, c4d, c5i, c5d = Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0)), Racional(elegir(-10,11, 0))

if opcion==1:
    #===============================================Aquí va el número del ejercicio y el enunciado.
    enunciado = f"¿Cuál de las siguientes ecuaciones se obtiene al dividir entre {Matematica(c)} en ambos lados de la ecuación {Matematica(Pol('x',a)+'='+b)}?"
    ...
    #===============================================Aquí va el número del ejercicio y el enunciado.
    enunciado = f"¿Cuál de las siguientes ecuaciones se obtiene al dividir entre {Matematica(c)} en ambos lados de la ecuación {Matematica(b+'='+Pol('x',a))}?"
    #===================================Aquí se escriben los contenidos de las alternativas. Pon el correcto en el primero.
